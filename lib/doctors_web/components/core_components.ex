defmodule DoctorsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DoctorsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DoctorsWeb.Gettext, "errors", msg, opts)
    end
  end
